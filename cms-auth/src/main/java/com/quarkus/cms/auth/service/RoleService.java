...
/**
 * Service for managing roles and their permission grants.
 *
 * <p>Mirrors Strapi's admin role management: roles have a code (unique key), a display name, and a
 * collection of permission grants. Default roles (Public, Authenticated) are seeded at startup.
 */
@ApplicationScoped
public class RoleService {
  ...
  public CmsPermission addPermission(
      Long roleId, String action, String subject, List<String> fields, Map<String, Object> conditions) {
    CmsRole role = findById(roleId);
    if (role == null) {
      throw new IllegalArgumentException("Role not found: " + roleId);
    }
